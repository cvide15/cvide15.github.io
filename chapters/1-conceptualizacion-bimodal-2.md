...
bajo la <a href="https://es.wikipedia.org/wiki/Dicotom%C3%ADa" title="Dicotomía (del griego dichótomos, «dividido en partes» o «cortado en dos partes», proveniente a su vez de dícha «en dos partes» y témnein «cortar») es un concepto que puede designar un par de conceptos complementarios, o bien una subdivisión, que desmiembra o disecta el área de un objeto en exactamente dos áreas (o en su defecto, conceptos) complementarias.">dicotomía</a> dictatorial o democrática indica que los <a href="https://es.wikipedia.org/wiki/Fermi%C3%B3n" title="Un fermión es uno de los dos tipos básicos de partículas elementales que existen en la naturaleza (el otro tipo es el bosón). Los fermiones se caracterizan por tener espín semientero (1/2, 3/2, ...) y, por tanto, estar sujetos al principio de exclusión de Pauli.">fermiones</a>
